> **Note on Repository History:** This repository serves as a clean, production-ready showcase of the finalized application. The original, iterative development and version control history were maintained in a private collaborative workspace.
